...
# Если готовый текст уведомления содержит любое из этих слов/фраз (без учёта
# регистра), уведомление НЕ отправляется в Telegram. Используется и для
# истории версий (_HISTORY_by_date.txt), и для обычных json-файлов с версией.
BLOCKED_KEYWORDS = [
    "Counter Strike 2",
    "Counter Strike",
    "Unknown App",
